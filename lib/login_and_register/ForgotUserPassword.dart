...
class ForgotUserPassword extends StatefulWidget {
  const ForgotUserPassword({super.key});

  @override
  State<ForgotUserPassword> createState() => _ForgotUserPasswordState();
}

class _ForgotUserPasswordState extends State<ForgotUserPassword> {
                ...
                child: ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    if (await checkEmailExists(newMail) == true) {
                      ...
                      setState(() {
                        error_ = "There isn't an account from this email.";
                      });
                    }
                  },
