...
class ForgotOfficerPassword extends StatefulWidget {
  const ForgotOfficerPassword({super.key});

  @override
  State<ForgotOfficerPassword> createState() => _ForgotOfficerPasswordState();
}

class _ForgotOfficerPasswordState extends State<ForgotOfficerPassword> {
                ...
                child: ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    if (await checkEmailExists(newMail) == true) {
                      ...
                      setState(() {
                        err = "There isn't an account from this email";
                      });
                      return;
                    }
                  },
